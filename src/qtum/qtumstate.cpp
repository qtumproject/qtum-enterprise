...
ResultExecute QtumState::execute(EnvInfo const& _envInfo, SealEngineFace const& _sealEngine, QtumEthTransaction const& _t, Permanence _p, OnOpFunc const& _onOp){

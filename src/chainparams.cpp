...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("qtum3.dynu.net", false); // Pieter Wuille, only supports x1, x5, x9, and xd
        ...
        checkpointData = (CCheckpointData) {
                {
                        ...
                        {5000, uint256S(
                                "00006a5338e5647872bd91de1d291365e941e14dff1939b5f16d1804d1ce61cd")} //last PoW block
                }
        };

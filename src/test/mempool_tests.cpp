...
BOOST_AUTO_TEST_CASE(MempoolSizeLimitTest)
{
    ...
    tx1.vout[0].nValue = 10 * COIN;
    pool.addUnchecked(tx1.GetHash(), entry.Fee(100000LL).FromTx(tx1));
    ...
    pool.addUnchecked(tx2.GetHash(), entry.Fee(50000LL).FromTx(tx2));
    ...
    pool.addUnchecked(tx3.GetHash(), entry.Fee(200000LL).FromTx(tx3));
    ...
    pool.addUnchecked(tx4.GetHash(), entry.Fee(70000LL).FromTx(tx4));
    pool.addUnchecked(tx5.GetHash(), entry.Fee(10000LL).FromTx(tx5));
    pool.addUnchecked(tx6.GetHash(), entry.Fee(11000LL).FromTx(tx6));
    pool.addUnchecked(tx7.GetHash(), entry.Fee(90000LL).FromTx(tx7));

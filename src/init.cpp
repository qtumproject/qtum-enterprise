    ...
    while (!fLoaded && !fRequestShutdown) {
        ...
        do {
            try {
                ...
                /////////////////////////////////////////////////////////// qtum
                if((gArgs.GetBoolArg("-dgpstorage", false) && gArgs.GetBoolArg("-dgpevm", false)) || (!gArgs.GetBoolArg("-dgpstorage", false) && gArgs.GetBoolArg("-dgpevm", false)) ||
                  (!gArgs.GetBoolArg("-dgpstorage", false) && !gArgs.GetBoolArg("-dgpevm", false))){
                ...
                fRecordLogOpcodes = gArgs.GetBoolArg("-record-log-opcodes", false);

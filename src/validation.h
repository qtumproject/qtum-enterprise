...
public:
    ...
    ByteCodeExec(std::vector<QtumTransaction> _txs, const qtum::vm::QtumBlockchainDataFeed& _chainFeed) : txs(_txs), chainFeed(_chainFeed) {}
...
private:
    ...
    const qtum::vm::QtumBlockchainDataFeed& chainFeed;
